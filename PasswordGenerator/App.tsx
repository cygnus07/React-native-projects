  ...
  return (
   <ScrollView keyboardShouldPersistTaps="handled">
      <SafeAreaView style={styles.appContainer}>
       ...
       onSubmit={ values => {
        console.log(values)
        generatePasswordString(+values.passwordLength) // it will give string so...
        // + will convert it to number if its already not a number
       }}
        ...
        <>  
          <View style={styles.inputWrapper}>
            <View style={styles.inputColumn}>
              ...
              {/* //error something read about it more */}
          ...
          <View style={styles.inputWrapper}>
            ...
            <BouncyCheckbox
              //  disableBuiltInState // its not used anymore so no need
              isChecked={lowerCase}
          ...
          <View style={styles.formActions}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                handleReset();
                resetPasswordState()  // need a reading here
              }}
            >
